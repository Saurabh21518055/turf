...
function demoTurfs() {
  return [
    ...
    { id: 4, name: "Victory Grounds", state: "Gujarat", city: "Ahmedabad", area: "Navrangpura", price: 1200, rating: 4.8, facilities: ["Floodlights", "Parking"], photo: "assets/img/turff.jpg" },
